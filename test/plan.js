...
describe("DuniaPay Plan", function() {
  ...
  it("should update a plan", function(done) {
    DuniaPay.plan.update(plan_id, {'name': 'Monthly Subscription for API Course'}).then(function(body){
  ...
  it("should get details of a plan", function(done) {
    DuniaPay.plan.get(plan_id).then(function(body){
      expect(body).to.have.property('data');
      expect(body.data).to.have.property('id');
  ...
  it("should list plan", function(done) {
    DuniaPay.plan.list().then(function(body){
      expect(body).to.have.property('data');
