...
describe("DuniaPay Subscriptions", function() {
  ...
  it("should get details of a subscription", function(done) {
    DuniaPay.subscription.get(subscription_id, function(error, body) {
  ...
  it("should get enable subscription", function(done) {
    DuniaPay.subscription.enable({code: subscription_code, token: token}, function(error, body) {
  ...
  it("should get disable subscription", function(done) {
    DuniaPay.subscription.disable({code: subscription_code, token: token}, function(error, body) {
