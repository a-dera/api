...
describe("DuniaPay Customers", function() {

  var customer_id;

  // New Customer
  it("should create a new customer", function(done) {
    DuniaPay.customer.create({
        first_name: 'Opeyemi',
        last_name: 'Obembe',
  ...
  it("should update a customer", function(done) {
    DuniaPay.customer.update(customer_id, {last_name: 'Kehers'})
    .then(function(body){
      expect(body).to.have.property('data');
      expect(body.data).to.have.property('id');
      done();
  ...
  it("should get a customer's details", function(done) {
    DuniaPay.customer.get(customer_id)
    .then(function(body){
      expect(body).to.have.property('data');
      expect(body.data).to.have.property('id');
      done();
  ...
  it("should whitelist customer", function(done) {
    DuniaPay.customer.setRiskAction({
