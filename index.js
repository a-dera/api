...
function DuniaPay(key) {
  if (!(this instanceof DuniaPay)) {
    return new DuniaPay(key);
  }
...
DuniaPay.prototype = {
  ...
  importResources: function() {
    ...
    for (var j in resources) {
      ...
      DuniaPay.prototype[j] = new anon();
    }
  }
};


module.exports = DuniaPay;
